...
// for rates per 10,000 by gender
// *********************************************** 
...
//    .interpolate("cardinal")
    ...
    var yValue = function (d) {
        //        console.log("YVAL", d.data, [d.gender + "_late_stage"], d.data[d.gender + "_late_stage"]);
    ...
    function draw() {
        genders.forEach(function (d, i) {
            ...
            datasetByGender.push({
                gender: d,
                ratesByYear: rates
            });
        });

        console.log("databy gender", datasetByGender);
        ...
        yScale.domain([
    	d3.max(datasetByGender, function (d) {
...
//            .text("Rates per 10,000 by Gender");
        ...
        /*=====================================================================
                  Lines
======================================================================*/
        //Make a group for each gender
        var groups = svg.selectAll("g.lines")
            .data(datasetByGender)
            .enter()
            .append("g")
            .attr("class", "lines");
...
======================================================================*/
        ...
        svg.selectAll("circle.voronoi")
            ...
            .attr("class", function (d) {
                return "voronoi " + d.gender + d.year;
            })
            .attr("r", 1)
            .style("opacity", 0)
            .attr("stroke", "none")
    ...
    function mousemoveFunc(d) {
        ...
        return tooltip
            ...
            .html("<p class='sans'><span class='tooltipHeader'>" + uppercase(d.gender) + ", " + d.year + "</span><br>Rate: " + d3.format(".2f")(d.rate) + "</p>");
    }
