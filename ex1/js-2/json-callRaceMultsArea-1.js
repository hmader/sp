    ...
    function draw() {
        ...
        var mults = d3.select(chartID).selectAll("svg")
            ...
            .each(function (d, i) {
                ...
                var div = d3.select(this).append("svg").append("g");
                console.log("DIV", div);
                ...
                g.append("rect")
                    ...
                    .attr("width", width - margin.left - margin.left) // extra space for labels that appear
                ...
                lines.append("text")
                    ...
                    .attr("fill", "#aaa")
                    .style("pointer-events", "none")
                    .attr("dy", 13).attr("y", height - margin.top - margin.bottom)
                    .attr("x", margin.left)
                    .text(function (c) {
